    ...
    for epoch in range(initial_epoch, config["num_epochs"]):
        ...
        for batch in batch_iterator:
            ...
            if(config["remove_parts"]):
                ...
                encoder_output = model.encode(encoder_input_removed, None)  #(Batch, seq_len) --> (Batch, seq_len, d_model)
            else:
                #train model without interpolation purpose
                encoder_output = model.encode(encoder_input, None)          #(Batch, seq_len) --> (Batch, seq_len, d_model)
